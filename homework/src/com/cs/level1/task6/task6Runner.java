...
public class task6Runner {
    ...
    public static void main(String[] args) {
        int[] values = {2, 3, 4, 5};
        double mean = meanNumber(values);
        int number = numberOfElements(values);
        System.out.println("Среднее арифметическое: " + mean);
        System.out.println("Количество элементов массива больше среднего значения: " + number);
    }
